    <template>
      <header class="banner">
        <div class="apresentacao">
          ...
          <p class="cabecalho-lg frase-cabecalho">
            <span class="texto-verde">Um banquete de ideias para</span>
             despertar para o chef que há em você!
          </p>
        ...
        <img src="./assets/images/foto-banner.png" alt="Foto de uma mulher cozinhando com uma bacia de vidro
        nas mãos. Ela está sorrindo e está apoiando um celular entre seu rosto e ombro" class="foto-banner">
      </header>
    </template>
